...
/*	UART2 section
 */
volatile char UART2_SR      @0x5240;	/* Status register */
volatile char UART2_DR      @0x5241;	/* Data register */
volatile char UART2_BRR1    @0x5242;	/* Baud Rate reg 1 */
volatile char UART2_BRR2    @0x5243;	/* Baud Rate reg 2 */
volatile char UART2_CR1     @0x5244;	/* Control register 1 */
volatile char UART2_CR2     @0x5245;	/* Control register 2 */
volatile char UART2_CR3     @0x5246;	/* Control register 3 */
volatile char UART2_CR4     @0x5247;	/* Control register 4 */
volatile char UART2_CR6     @0x5249;	/* Control register 6 */
volatile char UART2_GTR     @0x524a;	/* Guard Time register */
volatile char UART2_PSCR    @0x524b;	/* Prescaler register */
...
/*	ADC section
 */
volatile char ADC_DBR[20]   @0x53e0;	/* data buffer registers */
